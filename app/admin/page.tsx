...
// Error Boundary to catch and display actual errors
    ...
    if (this.state.hasError) {
      return (
        <div className="flex min-h-screen items-center justify-center bg-red-50 px-4">
          <div className="max-w-xl rounded-xl bg-white p-8 shadow-lg">
            <h1 className="mb-4 text-xl font-bold text-red-600">Admin Error</h1>
            <pre className="whitespace-pre-wrap rounded bg-red-100 p-4 text-sm text-red-800">
